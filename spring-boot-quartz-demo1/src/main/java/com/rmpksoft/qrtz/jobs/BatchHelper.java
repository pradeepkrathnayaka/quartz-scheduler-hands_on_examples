...
public class BatchHelper {
	...
	public static JobParameters getJobParameters(JobExecutionContext context) throws SchedulerException {
		...
		return new JobParametersBuilder(
				getMergedJobParameters((JobParameters) jobDataMap.get(JOB_PARAMETERS_NAME_KEY_BY_CONFIG),
						(JobParameters) jobDataMap.get(JOB_PARAMETERS_NAME_KEY_BY_TRIGGER)))
								...
								.addLong(JOB_PARAMETERS_TIMESTAMP_KEY, System.currentTimeMillis()).toJobParameters();
	}
